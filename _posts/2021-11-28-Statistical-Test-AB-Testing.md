...
### Dataset Used
Mobile Games A/B Testing with Cookie Cats Project data downloaded from https://www.datacamp.com/projects/184
...
The above output indicates a high standard deviation with number of gamerounds played ranging from 0 to 49854.
...
#### Observation 1:
**4.4%** of users (3,994 users) downloaded the games but did not play a single level.
...
#### Observation 2:
**22.9%** of users (20,723 users) played 5 levels or less.
...
df_pct
```
<img width="306" alt="image" src="https://user-images.githubusercontent.com/85727619/143749917-953ee8dc-5af6-4dfe-a4c8-a2a4e891e5dd.png">

The table above shows the number of users retained after 1 day, 7 days and the total & mean gamerounds played for each version.
...
#### Compare Gate_30 and Gate_40 Version:
...
H0: Both groups have equal variances
H1: Both groups do not have equal variances
...
H0: Both Group A and B have equal mean number of gamerounds played.
H1: Both Group A and B do not have equal mean number of gamerounds played.
...
1. Gate_30 has higher retention rate after 1 day & 7 days as compared to Gate_40 version.
2. Users in Gate_30 version played slightly more gamerounds (51.34) than users in Gate_40 version (51.30).
...
max_gamerounds
```
<img width="124" alt="image" src="https://user-images.githubusercontent.com/85727619/143763314-d7ed826a-4c15-46bd-95f5-0bf6eca7d065.png">
...
```
<img width="130" alt="image" src="https://user-images.githubusercontent.com/85727619/143763110-0daf93b4-4ca5-4bca-86e5-97437f09ef74.png">

Comparision of gamerounds played for both groups (all users who downloaded vs users retained after 7 days)
<img width="120" alt="image" src="https://user-images.githubusercontent.com/85727619/143763469-3b506a43-3bb8-4511-a728-113840580ab1.png">


Whether to place the gate at level 30 or 40 depends highly on the objective of the game producer. If the aim is to retain as many users as possible after 7 days, then the gate should be kept at level 30.
Nevertheless, if the aim is to generate higher revenue through in-app purchases, the focus might be shifted to more gamerounds played, as players in higher levels might have better chance on spending on in-app purchase.
It is recommended to also include other dimensions (such as in-app purchase spending) into the analysis if the aim is about generating higher revenue.
